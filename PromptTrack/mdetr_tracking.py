...
class PromptTracker():
    ...
    def process_a_frame(self,frame, frame_id, prompt="pigs",nms_threshold=0.8,detector="OWL-VITV2"):
    ...
    def process_mot(self, video_file, fixed_parc=True, nbr_items=15, track_thresh=0, match_thresh=1, frame_rate=25, track_buffer=10000, max_time_lost=20000):
        """
